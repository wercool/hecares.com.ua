...
INSERT INTO users (id, username, password, first_name, last_name, email, phone_number, enabled, last_password_reset_date) VALUES (2, 'user',    '$2a$04$mrdlLQBTR4Hnrl6J2QuOy.C/kt8GoDHPO79qK604nzw.9lyBE7uzO', 'Initial', 'User',       'email@email.no',    '+000000000000', true, NOW());
